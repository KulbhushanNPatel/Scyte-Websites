...
export default function HeroScrollSequence() {
  ...
  return (
    <>
      {/* 1. Custom Cursor */}
      <div ref={cursorRef} className="fixed top-0 left-0 w-4 h-4 bg-[#cfc7aa] rounded-full pointer-events-none z-[9999] mix-blend-difference transform -translate-x-1/2 -translate-y-1/2 hidden md:block" />
